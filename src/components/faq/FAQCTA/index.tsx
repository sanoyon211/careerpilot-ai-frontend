...
export function FAQCTA() {
  return (
    <div className="mt-16 bg-[#FAFAFA] border border-[#E5E7EB] rounded-xl p-10 text-center max-w-3xl mx-auto">
      ...
      <Link href="/contact">
        <Button size="lg" className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white font-extrabold rounded-lg px-8 py-3.5">
          Get in Touch
        </Button>
      </Link>
    </div>
